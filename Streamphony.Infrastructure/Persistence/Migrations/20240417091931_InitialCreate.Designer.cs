...
namespace Streamphony.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240417091931_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Streamphony.Domain.Models.UserPreferences", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Streamphony.Domain.Models.UserPreferences", b =>
                {
                    b.HasOne("Streamphony.Domain.Models.User", "User")
                        .WithOne("Preferences")
                        .HasForeignKey("Streamphony.Domain.Models.UserPreferences", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
