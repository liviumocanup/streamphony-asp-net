...
public class CreateGenreTests
{
    ...
    public void Setup()
    {
        ...
        _handler = new CreateGenreHandler(_unitOfWorkMock.Object, _mapperMock.Object, _loggerMock.Object,
        ...
        _unitOfWorkMock.Setup(u => u.GenreRepository.Add(_genreEntity, It.IsAny<CancellationToken>()))
            .ReturnsAsync(_genreEntity);
    ...
    public async Task Handle_GenreIsUnique_CreatesGenreSuccessfully()
    {
        ...
        _validationServiceMock.Verify(
            v => v.EnsureUniqueProperty(It.IsAny<Func<string, CancellationToken, Task<Genre?>>>(),
                nameof(_genreCreationDto.Name), _genreCreationDto.Name, It.IsAny<CancellationToken>(),
    ...
    public void Handle_GenreNameNotUnique_ThrowsDuplicateException()
    {
        ...
        _validationServiceMock.Setup(v =>
                v.EnsureUniqueProperty(It.IsAny<Func<string, CancellationToken, Task<Genre?>>>(),
                    nameof(_genreCreationDto.Name), _genreCreationDto.Name, CancellationToken.None, LogAction.Create))
        ...
        _unitOfWorkMock.Verify(u => u.GenreRepository.Add(It.IsAny<Genre>(), It.IsAny<CancellationToken>()),
            Times.Never());
