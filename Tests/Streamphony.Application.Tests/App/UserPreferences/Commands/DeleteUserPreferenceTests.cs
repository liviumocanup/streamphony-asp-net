...
public class DeleteUserPreferenceTests
{
    ...
    public void Setup()
    {
        ...
        _handler = new DeleteUserPreferenceHandler(_unitOfWorkMock.Object, _loggerMock.Object,
    ...
    public async Task Handle_UserPreferenceExists_DeletesSuccessfully()
    {
        ...
        _validationServiceMock.Setup(v => v.AssertEntityExists(_unitOfWorkMock.Object.UserPreferenceRepository,
                userPreferenceId, It.IsAny<CancellationToken>(), LogAction.Delete))
        ...
        _unitOfWorkMock.Verify(u => u.UserPreferenceRepository.Delete(userPreferenceId, CancellationToken.None),
            Times.Once());
    ...
    public void Handle_UserPreferenceDoesNotExist_ThrowsNotFoundException()
    {
        ...
        Assert.ThrowsAsync<NotFoundException>(
            () => _handler.Handle(deleteUserPreferenceCommand, CancellationToken.None));
        _unitOfWorkMock.Verify(u => u.UserPreferenceRepository.Delete(It.IsAny<Guid>(), It.IsAny<CancellationToken>()),
            Times.Never());
        _loggerMock.Verify(l => l.LogSuccess(nameof(UserPreference), userPreferenceId, LogAction.Delete),
            Times.Never());
    }
}
