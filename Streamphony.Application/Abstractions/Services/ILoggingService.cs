...
public interface ILoggingService
{
    ...
    void LogAndThrowNotFoundException<T>(string entityName, string propertyName, T propertyValue, LogAction logAction = LogAction.Login);
    ...
    void LogAndThrowDuplicateExceptionForArtist<T>(string entityName, string propertyName, T propertyValue, Guid ownerId, LogAction logAction);
}