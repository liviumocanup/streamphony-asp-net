...
public record GetArtistForUser(Guid Id) : IRequest<ArtistResponseDto>;

public class GetArtistForUserHandler(
    IUnitOfWork unitOfWork,
    IMappingProvider mapper,
    IValidationService validationService,
    IUserManagerProvider userManagerProvider) : IRequestHandler<GetArtistForUser, ArtistResponseDto>
{
    ...
    public async Task<ArtistResponseDto> Handle(GetArtistForUser request, CancellationToken cancellationToken)
    {
